<?php include 'header.html'; ?>
    <!-- masthead -->
    <div class="jumbotron">
      <h2 class="jumbotron--title">Open Apparatus</h2>
      <p class="jumbotron--sub-title">AngularJS <span class="icon-star"></span> Firebase <span class="icon-star"></span> Partial Design</p>
      <a href="http://www.openapparatus.com/#/" class="btn  btn--green">View Site</a>
    </div><!-- /masthead -->
        ...
        <div class="container  main-content">
          ...
          <div class="row">
            ...
            <div class="col-lg-8  blog">
              ...
              <!-- blog post -->
              <img src="img/OAbig.jpg" class="blog-main-img  img-responsive" alt="blog main image" />

              <h4 class="blog-post-title">User Platform in Angular</h4>  
                <ul class="list-unstyled  tags  blog-tags">
                  <li><a href="http://www.openapparatus.com/#/">View Site</a></li>
                  <li><a href="https://github.com/johndangerstorey">GitHub</a></li>
                </ul>
